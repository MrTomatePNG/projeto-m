    ...
    <section class="card">
      ...
      >
        ...
        <div class="row">
          ...
          <button type="button" class="secondary" on:click={() => void me()} disabled={loading || !accessToken}>
            Testar /api/me
          </button>
        </div>

        <div class="row">
          <button type="button" class="danger" on:click={clearToken} disabled={loading || !accessToken}>
            Limpar token
          </button>
        </div>
      </form>
      ...
      <div class="token">
        ...
        <textarea readonly rows="3" value={accessToken} />
      </div>
